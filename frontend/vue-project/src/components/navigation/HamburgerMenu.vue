<template>
  ...
  <div class="search-container">
    <input
      ...
      class="search-input"
    />
    <img src="../../assets/images/211817_search_strong_icon.png" alt="Search Icon" class="search-icon"/>
  </div>
  ...
  <aside :class="['sidebar', { open: isSidebarOpen }]">
    ...
    <nav>
      ...
      <ul class="category-list">
        ...
        <li><a href="/beauty-health" :class="isActive('/beauty-health')">Beauty, Personal & Health</a></li>
        <li><a href="/machine-industrials" :class="isActive('/machine-industrials')">Machine & Industrials</a></li>
        <li><a href="/clothes-apparels" :class="isActive('/clothes-apparels')">Clothes & Apparels</a></li>
        <li><a href="/sports-outdoor" :class="isActive('/sports-outdoor')">Sports, Outdoor & Entertainment</a></li>
        <li><a href="/ikea" :class="isActive('/ikea')">Ikea</a></li>
        <li><a href="/baby-kids-games" :class="isActive('/baby-kids-games')">Baby, Kids & Games</a></li>
        <li><a href="/office" :class="isActive('/office')">Office</a></li>
        <li><a href="/buy4me" :class="isActive('/buy4me')">Buy4Me</a></li>
        <li><a href="/swag-gift-items" :class="isActive('/swag-gift-items')">Swag/Branded Gift Items</a></li>
        <li><a href="/agriculture-food-drinks" :class="isActive('/agriculture-food-drinks')">Agriculture, Food & Drinks</a></li>
      </ul>
    </nav>
  </aside>
</template>
...
<style scoped>
  ...
  .page-list a.active-link, .category-list a.active-link {
  color: #ff6600;
}
